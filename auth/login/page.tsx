...
import { Globe2, ArrowRight, Mail, Lock, Eye, EyeOff } from "lucide-react"
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between bg-primary/5 p-12 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="mt-4 text-muted-foreground">
            Join 5,000+ aspirants who trusted us with their work and study visa journeys.
          </p>
        </div>
      ...
      <div className="flex w-full flex-col justify-center px-6 py-12 lg:w-1/2 lg:px-16">
        ...
        >
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Sign in to your account to track applications and book consultations.
          </p>
